...
int utn_getArrayNumeros(int* pArrayResultados,int limite,const char *mensaje,const char *mensajeError,int minimo,int maximo,int reintentos)
{
    int ret;
    int num;
