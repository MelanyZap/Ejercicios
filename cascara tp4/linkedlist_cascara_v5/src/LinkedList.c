...
LinkedList* ll_newLinkedList(void)
{
    ...
    if(this != NULL)
    {
        this->size=0; //por ahora no tiene elementos por eso se declara con 0.
        this->pFirstNode = NULL; //dice que el primer elemento no tiene nada (por el momento) hasta que se vayam cargando datos.
    }
    return this;
}
...
int ll_len(LinkedList* this) //devuelve size
{
    int returnAux = -1; //-1 valor del error
